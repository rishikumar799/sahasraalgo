...
const WhatsAppIcon = () => (
  ...
  >
    <path
      fill="currentColor"
      d="M16.6,14.2l-1.5-0.8c-0.3-0.1-0.6,0-0.8,0.2l-0.5,0.6c-0.2,0.2-0.5,0.3-0.8,0.2c-0.7-0.3-1.6-0.8-2.3-1.6c-0.7-0.8-1.2-1.7-1.4-2.3c-0.1-0.3,0-0.6,0.2-0.8l0.5-0.6c0.2-0.2,0.3-0.5,0.2-0.8l-0.8-1.5c-0.1-0.3-0.4-0.4-0.7-0.3l-1.6,0.6C7.3,7.4,7,7.7,7,8.1c0,1,0.5,2.1,1,3c0.6,1,1.3,1.9,2.2,2.7c1.1,1,2.3,1.5,3.6,1.5c0.5,0,0.9-0.2,1.2-0.5L17,14.9C17.1,14.6,17,14.3,16.6,14.2z M12,2C6.5,2,2,6.5,2,12s4.5,10,10,10c5.5,0,10-4.5,10-10S17.5,2,12,2z"
    />
  </svg>
);
