...
const WhatsAppIcon = () => (
  ...
  >
    <path
      fill="currentColor"
      d="M19.05 4.94A10 10 0 0 0 12 2a10 10 0 0 0-10 10c0 3.14 1.46 5.92 3.78 7.75L2 22l3.27-1.68A10 10 0 0 0 12 22a10 10 0 0 0 7.05-2.95a10 10 0 0 0 0-14.1ZM12 20a8 8 0 0 1-4.4-1.3l-.3-.18l-3.26 1.07l1.09-3.18l-.2-.32A8 8 0 0 1 4 12a8 8 0 0 1 8-8a8 8 0 0 1 8 8a8 8 0 0 1-8 8Zm4.4-6.3c-.2-.1-.5-.2-1.1-.5s-1.8-.8-2.1-1c-.2-.1-.4-.1-.6.1c-.2.2-.8 1-1 1.2c-.2.2-.3.3-.6.1s-1.1-.4-2.1-1.3c-.8-.7-1.3-1.6-1.5-1.8c-.2-.3 0-.4.1-.5l.4-.5c.1-.1.2-.3.3-.4c.1-.2 0-.3-.1-.4l-.5-1.2c-.2-.5-.4-.9-.6-1.2c-.2-.3-.4-.2-.5-.2h-.5c-.2 0-.4.1-.6.3s-.8 1-1 2.4c-.2 1.4.2 2.8 1.4 4.3c1.2 1.5 2.5 2.8 4.2 3.7c.4.2.8.3 1.2.3c.5 0 1-.2 1.3-.4c.4-.3.8-.9.9-1.2s.1-.6 0-.8Z"
    />
  </svg>
);
